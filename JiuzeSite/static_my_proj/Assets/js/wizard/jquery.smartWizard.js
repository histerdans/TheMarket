...
function SmartWizard(target, options) {
    ...
    this.loader = $('<div class=""><i class="fa fa-spin"></></div>').addClass("loader");
    this.buttons = {
        next : $('<button>'+options.labelNext+'</button>').addClass("btn btn-success"),
        previous : $('<button>'+options.labelPrevious+'</button>').addClass("btn btn-primary"),
        finish  : $('<button>'+options.labelFinish+'</button>').attr("type","submit").addClass("btn btn-default")
    };
