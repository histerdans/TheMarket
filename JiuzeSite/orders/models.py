...
from JiuzeSite.utils import unique_order_id_generator
...
class ProductPurchase(models.Model):
    ...
    billing_profile     = models.CharField(max_length=120) # billingprofile.productpurchase_set.all()
    product             = models.TextField(max_length=10000) # product.productpurchase_set.count()
