...
from JiuzeSite import views
from accounts.views import LoginView, GuestRegisterView, RegisterView, register_page
...
urlpatterns = [
    ...
    path('create_user/', register_page, name='create_user'),
    path('producthome/', views.product_home, name='producthome'),
    ...
    url(r'^products/list$', ProductListView.as_view(), name='list'),
